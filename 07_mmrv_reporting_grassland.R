# ============================================================================
# MODULE 07: MMRV REPORTING & AAFC/Canadian Protocol VERIFICATION PACKAGE
# ============================================================================
# PURPOSE: Generate verification-ready outputs for AAFC/Canadian Protocol, ORRAA, and Canadian
#          grassland carbon standards including QA/QC documentation and spatial exports
# INPUTS:
...
#   - data_processed/cores_harmonized_grassland.rds (from Module 03)
# OUTPUTS:
...
for (method in METHODS_AVAILABLE) {
  ...
  # AAFC/Canadian Protocol estimates
  ...
  if (file.exists(vm0033_file)) {
    ...
    log_message(sprintf("  Loaded %s AAFC/Canadian Protocol estimates", method))
  }
}
...
# Calculate total area from AAFC/Canadian Protocol estimates
...
table1_metadata <- data.frame(
  Parameter = c(
    ...
    "Confidence Level",
    "AAFC/Canadian Protocol Compliance"
  ),
  Value = c(
    PROJECT_NAME,
    PROJECT_SCENARIO,
...
# ============================================================================
# TABLE 2: CARBON STOCKS BY STRATUM (AAFC/Canadian Protocol FORMAT)
# ============================================================================
...
metadata_content <- paste0(
  "AAFC/Canadian Protocol Grassland Carbon Verification Package\n",
  "========================================\n\n",
  ...
  "- carbon_stock_*_conservative.tif: AAFC/Canadian Protocol conservative estimates (lower 95% CI)\n",
  "\nPrediction Rasters:\n",
...
<html>
<head>
<title>AAFC/Canadian Protocol Grassland Carbon Verification Package</title>
<style>
...
<h1>🌊 AAFC/Canadian Protocol Grassland Carbon Verification Package</h1>
<p><strong>Project:</strong> %s<br>
<strong>Generated:</strong> %s<br>
<strong>Analysis Year:</strong> %d</p>

<div class="highlight">
<strong>AAFC/Canadian Protocol Compliance Status: <span class="success">✓ COMPLIANT</span></strong><br>
This package includes conservative estimates (lower 95%% confidence bound) as required by AAFC/Canadian Protocol methodology.
</div>
...
<ul>
<li>✓ Field sampling conducted following AAFC/Canadian Protocol protocols</li>
...
<strong>R Scripts:</strong> Module 01-07 (grassland carbon workflow)<br>
<strong>Configuration:</strong> grassland_carbon_config.R</p>

<hr>
<p><em>Generated by Grassland Carbon MMRV Workflow v1.0 | AAFC/Canadian Protocol & ORRAA Compliant</em></p>
  ...
  if (nrow(all_rows) > 0) {
    ...
    for (i in 1:nrow(all_rows)) {
      ...
      if (!is.na(all_rows$conservative_total_0_100_Mg[i])) {
        cat(sprintf("  Conservative Estimate: %.0f Mg C (AAFC/Canadian Protocol compliant)\n",
...
cat("----------------------------------------\n")
cat("  ✓ AAFC/Canadian Protocol (Verra) - Tidal Wetland & Seagrass Restoration\n")
cat("  ✓ ORRAA - High Quality Grassland Carbon Principles\n")
cat("  ✓ IPCC Wetlands Supplement - Conservative approach\n")
cat("  ✓ Canadian Grassland Carbon Network - Provincial applicability\n")
...
cat("🎉 Grassland Carbon MMRV Workflow Complete!\n")
