# ============================================================================
# MODULE 05: GRASSLAND CARBON RANDOM FOREST PREDICTIONS
# ============================================================================
# PURPOSE: Predict SOC using Random Forest with stratum-aware training
# INPUTS:
#   - data_processed/cores_harmonized_spline_grassland.rds
...
if (dir.exists(gee_strata_dir)) {
  ...
  stratum_mapping <- data.frame(
    ...
    file_name = c("upper_prairie.tif", "mid_prairie.tif", "lower_prairie.tif", "underwater_vegetation.tif", "open_water.tif"),
    stratum_code = 1:5
  )
...
for (depth in STANDARD_DEPTHS) {
  ...
  # Save combined SE (recommended for AAFC/Canadian Protocol)
...
# Default BD value if no data available (typical grassland carbon values)
...
cat("  - AAFC/Canadian Protocol layer aggregation with stock calculation\n")
