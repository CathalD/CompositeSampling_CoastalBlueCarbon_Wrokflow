# ============================================================================
# MODULE 03: GRASSLAND CARBON DEPTH HARMONIZATION USING SPLINES
# ============================================================================
...
if (file.exists("data_processed/vm0033_compliance.rds")) {
  ...
  log_message("Loaded AAFC/Canadian Protocol compliance data from Module 01")
}
...
#' Equal-area quadratic spline (AAFC/Canadian Protocol recommended method)
...
saveRDS(harmonized_cores, "data_processed/cores_harmonized_grassland.rds")
write.csv(harmonized_cores, "data_processed/cores_harmonized_grassland.csv",
          row.names = FALSE)
...
harmonization_metadata <- list(
  method = INTERPOLATION_METHOD,
  standard_depths = STANDARD_DEPTHS,
  vm0033_intervals = AAFC/Canadian Protocol_DEPTH_INTERVALS,
...
cat(sprintf("AAFC/Canadian Protocol target depths: %s cm\n", paste(STANDARD_DEPTHS, collapse = ", ")))
...
cat("\nSOC at AAFC/Canadian Protocol Surface Layer (7.5 cm) by Stratum:\n")
...
cat("\nOutputs:\n")
cat("  Data:\n")
cat("    data_processed/cores_harmonized_grassland.rds\n")
...
cat("\nKey Features:\n")
cat("  ✓ AAFC/Canadian Protocol standard depth intervals (0-15, 15-30, 30-50, 50-100 cm)\n")
cat("  ✓ Equal-area spline interpolation (AAFC/Canadian Protocol recommended)\n")
...
cat("  4. Run: source('04_raster_predictions_kriging_grassland.R')\n\n")
